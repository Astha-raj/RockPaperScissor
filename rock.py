...
#First we'll create labels and buttons

button_rock=Button(text="       Rock      ",bg="#088487",font=("arial",15,"italic bold"),
                    relief=RIDGE,activebackground="#05945B",activeforeground="white",width=24,command=rock)

button_rock.grid(column=0,row=1)

button_paper=Button(text="       Paper      ",bg="#088487",font=("ariel",15,"italic bold"),
                    relief=RIDGE,activebackground="#05945B",activeforeground="white",width=24,command=paper)


button_paper.grid(column=0,row=2)

button_scissor=Button(text="       Scissor      ",bg="#088487",font=("ariel",15,"italic bold"),
                    relief=RIDGE,activebackground="#05945B",activeforeground="white",width=24,command=scissor)
